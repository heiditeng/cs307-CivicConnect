...
const UserProfile = () => {
  ...
  useEffect(() => {
    // Fetch profile and bookmarks on component mount
  ...
  const fetchBookmarkedEvents = async (username) => {
    try {
      ...
      if (res.ok) {
        ...
        console.log("Bookmarked events fetched:", data.bookmarks);
        console.log("Rendered bookmarkedEvents:", bookmarkedEvents);
