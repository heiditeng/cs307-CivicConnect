    ...
    class ModifyEvent extends Component {
        ...
        handleSubmit = async (e) => {
            ...
            const isRecurring = Boolean(this.state.isRecurring);
            ...
            formData.append('isRecurring', this.state.isRecurring);
            if (this.state.isRecurring) {
                formData.append('recurrenceInterval', this.state.recurrenceInterval);
            }
                ...
                <div className="flex justify-center items-center min-h-screen p-4 bg-gray-100">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-2xl">
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="mb-4">
                                <label className="block font-semibold">Recurring Event:</label>
                                <input
                                    type="checkbox"
                            ...
                            {this.state.isRecurring && (
                                <div className="mb-4">
                                    <label className="block font-semibold">Recurrence Interval:</label>
                                    <select
