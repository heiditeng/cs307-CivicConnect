...
function ie(e) {
    ...
    }(r), d = c.x, g = c.y, u = r.hasOwnProperty("x"), l = r.hasOwnProperty("y"), v = V, f = D, y = window;
    if (m) {
        var j = B(n);
        j === k(n) && (j = z(n)),
        a === D && (f = R,
    ...
    return s ? Object.assign({}, p, ((h = {})[f] = l ? "0" : "",
    h[v] = u ? "0" : "",
    h.transform = (y.devicePixelRatio || 1) < 2 ? "translate(" + d + "px, " + g + "px)" : "translate3d(" + d + "px, " + g + "px, 0)",
    h)) : Object.assign({}, p, ((o = {})[f] = l ? g + "px" : "",
    o[v] = u ? d + "px" : "",
    o.transform = "",
    o))
}
...
function Eo(e) {
    var o = e.prefix
      ...
      , i = e.iconName;
    if (i)
        return yo(zo.definitions, n, i) || yo(Ze.styles, n, i)
}
                        ...
                        function k() {
                            ...
                            if (a && a.keys)
                                ...
                                for (var I = a.key; y >= 0; --y)
                                    ...
                                    b < h ? (f.add(P),
                                    ++b) : (++w,
                                    P.score > f.peek().score && f.replaceTop(P)),
                                    y % 1e3 == 0 && Date.now() - d >= 10)))
                                        return void (e ? setImmediate(k) : setTimeout(k))
                            } else
                                for (; y >= 0; --y) {
                                    var S, P;
                                    if ((S = n[y]) && (c(S) || (S = v.getPrepared(S)),
                                    null !== (P = p(o, S, u)) && !(P.score < j) && (b < h ? (f.add(P),
                                    ++b) : (++w,
                                    P.score > f.peek().score && f.replaceTop(P)),
                                    y % 1e3 == 0 && Date.now() - d >= 10)))
                                        return void (e ? setImmediate(k) : setTimeout(k))
